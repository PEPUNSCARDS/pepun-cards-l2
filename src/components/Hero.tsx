    ...
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-foreground mb-6">
          ...
          <br />
          <span className="text-accent">on Pepe Unchained L2</span>
        </h1>
        
        <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto">
          Top up with <span className="text-accent font-semibold">PEPU</span>, the Pepe Unchained Token
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="bg-card/50 backdrop-blur-sm rounded-lg p-6 border border-border/30 hover:border-accent/50 transition-all duration-300">
            <CreditCard className="w-8 h-8 text-accent mb-3 mx-auto" />
