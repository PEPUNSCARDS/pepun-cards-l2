    ...
    <section className="py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <Card className="bg-card/50 backdrop-blur-sm border-border/30 hover:border-accent/50 transition-all duration-300">
        ...
        <div className="text-center mt-12">
          <div className="bg-accent/10 border border-accent/30 rounded-lg p-6 max-w-2xl mx-auto">
            <p className="text-foreground text-lg font-medium">
              <span className="text-accent font-bold">No Annual Fees</span> • 
              <span className="text-accent font-bold"> No Monthly Fees</span> • 
              <span className="text-accent font-bold"> No Hidden Charges</span>
            </p>
          </div>
        </div>
      </div>
